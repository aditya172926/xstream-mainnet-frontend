...
const StreamInfo = ({
  ...
  const calculateFlowRate = (amountInEther) => {
    ...
    return calculatedFlowRate / 10 ** 18; // not sure if we should do this
  };
    ...
    <div className="px-6">
      ...
      >
        <div className="flex justify-between items-center w-full">
          ...
          <p className="text-sm font-semibold m-0 w-[174px] leading-[normal] text-[rgba(150,208,104,1)]">
        ...
        <div className="flex justify-between items-start w-full">
          ...
          <p className="text-sm font-semibold m-0 leading-[normal] text-[rgba(150,208,104,1)]">
            {endDate.$d.toLocaleDateString(undefined, dateFormatOptions)}, {endDate.$d.toLocaleTimeString()}
          </p>
        </div>
        <div className="flex justify-between items-start w-full">
          <p className="text-sm font-normal m-0 leading-[normal] text-[rgba(70,70,70,1)]">
